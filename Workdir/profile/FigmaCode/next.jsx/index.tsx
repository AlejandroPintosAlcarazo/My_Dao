...
const GalileoDesign1: NextPage = () => {
  return (
    <div className={styles.galileoDesign9}>
        ...
        <section className={styles.depth1Frame0}>
          ...
          <div className={styles.depth2Frame1}>
            <Depth3Frame
              ...
              vector02="/vector--0-3.svg"
              vector03="/vector--0-4.svg"
              vector04="/vector--0-5.svg"
              vector05="/vector--0-6.svg"
              vector06="/vector--0-7.svg"
            />
